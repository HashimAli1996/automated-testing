...
public class MattCookie {
	...
	public void setup() {
		...
		report = new ExtentReports("C:\\Users\\Administrator\\Desktop\\EclipseWorkspace\\testingProjectArtifact\\cookie_test.html", true);
	...
	public void login() {
		...
		driver.findElement(By.id("user-identifier-input")).sendKeys("hashim.ali@qa.com");

	
		driver.findElement(By.id("password-input")).sendKeys("batman65523");
